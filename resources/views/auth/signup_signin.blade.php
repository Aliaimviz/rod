...
<div class="container no-padding">
    <!--signup-->
    <div class="col-lg-5 col-md-12 col-sm-12 float no-padding">
        <h2 class="formbox">
        ...
        <div id="logbox" class="signup">
            <form id="register_form" method="post" action="{{route('signup')}}" role="form" class="form-horizontal">
                ...
                <div class="form-group user-name sel-box country col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <input type="submit" class="btn btn-primary sends mgg-top" name="submit" value="submit"/>
    ...
    <div class="col-lg-2 col-md-12 col-sm-12 float none">
        <div class="wrapper">
            <div class="line"></div>
