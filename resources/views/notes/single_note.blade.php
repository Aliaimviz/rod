                    ...
                    <div class="col-lg-10">
                        <div class="row">
                            <div class="col-lg-7 notes-title">
                                ...
                                <p class="p-author">Posted by <a href="#">@if($tutorFlag){{$authorDetail->tutor_unique}}@else {{$authorDetail->username}}@endif</a></p>
                            </div>
...
{{--Note Slider End--}}
                ...
                <div class="row about-author">
                    <div class="col-lg-12">
                        <h2><span>About</span> the Author</h2>
                    </div>
                    <div class="clearfix">&nbsp;</div>
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                        @if($tutorFlag)@if(!empty($authorDetail->profile_pic))
                            <img class="img-responsive" src="{{asset('/public/profile_pics/')}}/{{$authorDetail->profile_pic}}">
                                           @else
                            <img class="img-responsive" src="{{asset('/public/images/profile-icon.png')}}">
                        @endif
                        @else
                            <img class="img-responsive" src="{{asset('/public/images/profile-icon.png')}}">
                        @endif
                    ...
                    <div class="col-lg-10 col-md-8 col-sm-8 col-xs-12">
                        ...
                        <a href="{{ route('profile_view', ['id' => $authorDetail->users_id ]) }}">
                            ...
                            <p>{{$authorDetail->tutor_about}}
                            <a tutor_id="{{$authorDetail->users_id }}" href="#groupModal" data-toggle="modal" data-target="#groupModal" class="btn btn-primary pull-right create_contact">Contact With Tutor</a>
                            </p>
                ...
                <div class="row download-note about-author ">
                    <div class="col-lg-12">
                        <h2><span>Download</span> this Note</h2>
                    </div>
                    <div class="clearfix">&nbsp;</div>
                    <div class="col-lg-2">
            ...
            <div class="col-md-4 rec-posts">
                ...
                <ul class="popular-posts list-unstyled">
                    ...
                    <li class="row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-10 r-text">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center" style="align-content: center">
                        ...
                        {{--<h3 class="media-heading">{{$authorDetail->tutor_unique}} </h3>--}}
                        ...
                        {{--<span class="label label-warning">{{$authorDetail->tutor_skills}}</span>--}}
